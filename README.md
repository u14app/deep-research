...
<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=deep-research">
    <img src="./public/atlas-cloud-logo.png" alt="Atlas Cloud" width="200">
  </a>
</p>

> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=deep-research)** is a full-modal, OpenAI-compatible AI inference platform. Deep Research already ships it as a built-in provider — plug it in as a drop-in backend to drive both the *Thinking* and *Task* models from a single API (DeepSeek, Qwen, GLM, Kimi, MiniMax, Claude, GPT and more), with no multi-vendor setup. Budget-friendly: [coding plan](https://www.atlascloud.ai/console/coding-plan).

```bash
# Server-side env (see env.tpl). Use a reasoning-capable model for the Thinking model.
ATLASCLOUD_API_KEY=<atlascloud-api-key>
ATLASCLOUD_API_BASE_URL=https://api.atlascloud.ai
# Recommended default. deepseek-v4-pro is a reasoning model — give it enough max_tokens (>= 512).
# THINKING_MODEL=deepseek-ai/deepseek-v4-pro
```
